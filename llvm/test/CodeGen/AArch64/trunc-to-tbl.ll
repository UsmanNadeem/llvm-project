...
; CHECK-DISABLE-NEXT:    add x10, x9, #48
; CHECK-DISABLE-NEXT:    add x11, x9, #16
; CHECK-DISABLE-NEXT:    ld1 { v1.4s }, [x9]
; CHECK-DISABLE-NEXT:    ld1 { v0.4s }, [x10]
; CHECK-DISABLE-NEXT:    add x10, x9, #32
...
; CHECK-DISABLE-NEXT:    xtn v1.4h, v1.4s
; CHECK-DISABLE-NEXT:    cmp x8, #1000
; CHECK-DISABLE-NEXT:    xtn v0.4h, v0.4s
; CHECK-DISABLE-NEXT:    xtn v2.4h, v2.4s
; CHECK-DISABLE-NEXT:    xtn v3.4h, v3.4s
; CHECK-DISABLE-NEXT:    rev16 v1.8b, v1.8b
; CHECK-DISABLE-NEXT:    rev16 v0.8b, v0.8b
; CHECK-DISABLE-NEXT:    rev16 v2.8b, v2.8b
; CHECK-DISABLE-NEXT:    rev16 v3.8b, v3.8b
; CHECK-DISABLE-NEXT:    uzp1 v1.8b, v1.8b, v2.8b
; CHECK-DISABLE-NEXT:    uzp1 v0.8b, v3.8b, v0.8b
; CHECK-DISABLE-NEXT:    mov v1.d[1], v0.d[0]
; CHECK-DISABLE-NEXT:    st1 { v1.16b }, [x9]
...
; CHECK-BE-NEXT:    uzp1 v1.8b, v1.8b, v2.8b
; CHECK-BE-NEXT:    uzp1 v0.8b, v3.8b, v0.8b
...
; CHECK-DISABLE:       // %bb.0: // %entry
; CHECK-DISABLE-NEXT:    add x8, x0, #48
; CHECK-DISABLE-NEXT:    add x9, x0, #16
; CHECK-DISABLE-NEXT:    ld1 { v1.4s }, [x0]
; CHECK-DISABLE-NEXT:    ld1 { v0.4s }, [x8]
; CHECK-DISABLE-NEXT:    add x8, x0, #32
; CHECK-DISABLE-NEXT:    ld1 { v2.4s }, [x9]
; CHECK-DISABLE-NEXT:    ld1 { v3.4s }, [x8]
; CHECK-DISABLE-NEXT:    xtn v1.4h, v1.4s
; CHECK-DISABLE-NEXT:    xtn v0.4h, v0.4s
; CHECK-DISABLE-NEXT:    xtn v2.4h, v2.4s
; CHECK-DISABLE-NEXT:    xtn v3.4h, v3.4s
...
; CHECK-DISABLE-NEXT:    uzp1 v0.8b, v3.8b, v0.8b
; CHECK-DISABLE-NEXT:    mov v1.d[1], v0.d[0]
; CHECK-DISABLE-NEXT:    st1 { v1.16b }, [x1]
; CHECK-DISABLE-NEXT:    ret
entry:
...
; CHECK-DISABLE-NEXT:    rev16 v1.8b, v1.8b
; CHECK-DISABLE-NEXT:    rev16 v0.8b, v0.8b
; CHECK-DISABLE-NEXT:    uzp1 v0.8b, v1.8b, v0.8b
...
; CHECK-DISABLE-NEXT:    add x11, x9, #80
; CHECK-DISABLE-NEXT:    add x10, x9, #64
; CHECK-DISABLE-NEXT:    ld1 { v2.2d }, [x9]
; CHECK-DISABLE-NEXT:    ld1 { v1.2d }, [x11]
; CHECK-DISABLE-NEXT:    add x11, x9, #112
; CHECK-DISABLE-NEXT:    ld1 { v0.2d }, [x10]
; CHECK-DISABLE-NEXT:    ld1 { v3.2d }, [x11]
; CHECK-DISABLE-NEXT:    add x11, x9, #96
; CHECK-DISABLE-NEXT:    add x10, x9, #16
; CHECK-DISABLE-NEXT:    ld1 { v4.2d }, [x11]
; CHECK-DISABLE-NEXT:    add x11, x9, #32
; CHECK-DISABLE-NEXT:    add x9, x9, #48
; CHECK-DISABLE-NEXT:    ld1 { v5.2d }, [x10]
; CHECK-DISABLE-NEXT:    ld1 { v6.2d }, [x11]
; CHECK-DISABLE-NEXT:    ld1 { v7.2d }, [x9]
; CHECK-DISABLE-NEXT:    xtn v2.2s, v2.2d
; CHECK-DISABLE-NEXT:    xtn v3.2s, v3.2d
; CHECK-DISABLE-NEXT:    xtn v1.2s, v1.2d
; CHECK-DISABLE-NEXT:    xtn v4.2s, v4.2d
; CHECK-DISABLE-NEXT:    xtn v0.2s, v0.2d
; CHECK-DISABLE-NEXT:    add x9, x1, x8, lsl #4
; CHECK-DISABLE-NEXT:    xtn v7.2s, v7.2d
; CHECK-DISABLE-NEXT:    xtn v6.2s, v6.2d
; CHECK-DISABLE-NEXT:    xtn v5.2s, v5.2d
; CHECK-DISABLE-NEXT:    add x8, x8, #1
; CHECK-DISABLE-NEXT:    rev32 v2.4h, v2.4h
; CHECK-DISABLE-NEXT:    rev32 v3.4h, v3.4h
; CHECK-DISABLE-NEXT:    rev32 v1.4h, v1.4h
; CHECK-DISABLE-NEXT:    rev32 v4.4h, v4.4h
; CHECK-DISABLE-NEXT:    rev32 v0.4h, v0.4h
; CHECK-DISABLE-NEXT:    cmp x8, #1000
; CHECK-DISABLE-NEXT:    rev32 v7.4h, v7.4h
; CHECK-DISABLE-NEXT:    rev32 v6.4h, v6.4h
; CHECK-DISABLE-NEXT:    rev32 v5.4h, v5.4h
; CHECK-DISABLE-NEXT:    uzp1 v3.4h, v4.4h, v3.4h
; CHECK-DISABLE-NEXT:    uzp1 v0.4h, v0.4h, v1.4h
; CHECK-DISABLE-NEXT:    uzp1 v1.4h, v6.4h, v7.4h
; CHECK-DISABLE-NEXT:    uzp1 v2.4h, v2.4h, v5.4h
; CHECK-DISABLE-NEXT:    rev16 v3.8b, v3.8b
; CHECK-DISABLE-NEXT:    rev16 v0.8b, v0.8b
; CHECK-DISABLE-NEXT:    rev16 v1.8b, v1.8b
; CHECK-DISABLE-NEXT:    rev16 v2.8b, v2.8b
; CHECK-DISABLE-NEXT:    uzp1 v0.8b, v0.8b, v3.8b
; CHECK-DISABLE-NEXT:    uzp1 v1.8b, v2.8b, v1.8b
; CHECK-DISABLE-NEXT:    mov v1.d[1], v0.d[0]
; CHECK-DISABLE-NEXT:    st1 { v1.16b }, [x9]
...
; CHECK-DISABLE-NEXT:    rev32 v2.4h, v2.4h
; CHECK-DISABLE-NEXT:    rev32 v3.4h, v3.4h
; CHECK-DISABLE-NEXT:    uzp1 v1.4h, v1.4h, v2.4h
; CHECK-DISABLE-NEXT:    uzp1 v0.4h, v3.4h, v0.4h
; CHECK-DISABLE-NEXT:    rev16 v1.8b, v1.8b
; CHECK-DISABLE-NEXT:    rev16 v0.8b, v0.8b
; CHECK-DISABLE-NEXT:    uzp1 v0.8b, v1.8b, v0.8b
; CHECK-DISABLE-NEXT:    st1 { v0.8b }, [x9]
...
; CHECK-NEXT:    ubfx w11, w9, #12, #19
; CHECK-NEXT:    and w13, w10, #0x7ffff
; CHECK-NEXT:    ubfx x12, x9, #31, #19
; CHECK-NEXT:    fmov s1, w13
; CHECK-NEXT:    ubfx x14, x10, #19, #19
; CHECK-NEXT:    lsr x13, x9, #50
; CHECK-NEXT:    fmov s0, w11
; CHECK-NEXT:    ldrh w11, [x0, #16]
; CHECK-NEXT:    mov.s v1[1], w14
; CHECK-NEXT:    ubfx x14, x10, #38, #19
; CHECK-NEXT:    lsr x10, x10, #57
; CHECK-NEXT:    mov.s v0[1], w12
; CHECK-NEXT:    orr w12, w13, w11, lsl #14
; CHECK-NEXT:    ldrb w13, [x0, #18]
; CHECK-NEXT:    orr w9, w10, w9, lsl #7
; CHECK-NEXT:    add x0, x0, #32
; CHECK-NEXT:    and w12, w12, #0x7ffff
; CHECK-NEXT:    orr x11, x11, x13, lsl #16
; CHECK-NEXT:    mov.s v1[2], w14
; CHECK-NEXT:    and w9, w9, #0x7ffff
; CHECK-NEXT:    mov.s v0[2], w12
; CHECK-NEXT:    lsr x10, x11, #5
...
; CHECK-BE-NEXT:    fmov s1, w15
; CHECK-BE-NEXT:    ubfx x12, x9, #14, #18
; CHECK-BE-NEXT:    orr w13, w14, w13, lsl #14
; CHECK-BE-NEXT:    lsl x14, x9, #24
; CHECK-BE-NEXT:    extr x9, x10, x9, #40
; CHECK-BE-NEXT:    fmov s0, w11
; CHECK-BE-NEXT:    bfi x14, x16, #8, #16
; CHECK-BE-NEXT:    mov v1.s[1], w13
; CHECK-BE-NEXT:    ubfx x9, x9, #12, #20
; CHECK-BE-NEXT:    mov v0.s[1], w12
; CHECK-BE-NEXT:    lsr x11, x14, #19
; CHECK-BE-NEXT:    ubfx x12, x10, #7, #25
; CHECK-BE-NEXT:    ldrb w10, [x0, #18]
; CHECK-BE-NEXT:    add x0, x0, #32
; CHECK-BE-NEXT:    mov v1.s[2], w12
; CHECK-BE-NEXT:    mov v0.s[2], w11
; CHECK-BE-NEXT:    lsl x11, x16, #8
; CHECK-BE-NEXT:    orr w10, w10, w11
; CHECK-BE-NEXT:    mov v1.s[3], w9
; CHECK-BE-NEXT:    add x9, x1, x8, lsl #3
; CHECK-BE-NEXT:    add x8, x8, #1
...
; CHECK-BE-NEXT:    rev16 v1.8b, v1.8b
; CHECK-BE-NEXT:    rev16 v0.8b, v0.8b
; CHECK-BE-NEXT:    uzp1 v0.8b, v1.8b, v0.8b
...
; CHECK-DISABLE-NEXT:    fmov s1, w15
; CHECK-DISABLE-NEXT:    ubfx x12, x9, #14, #18
; CHECK-DISABLE-NEXT:    orr w13, w14, w13, lsl #14
; CHECK-DISABLE-NEXT:    lsl x14, x9, #24
; CHECK-DISABLE-NEXT:    extr x9, x10, x9, #40
; CHECK-DISABLE-NEXT:    fmov s0, w11
; CHECK-DISABLE-NEXT:    bfi x14, x16, #8, #16
; CHECK-DISABLE-NEXT:    mov v1.s[1], w13
; CHECK-DISABLE-NEXT:    ubfx x9, x9, #12, #20
; CHECK-DISABLE-NEXT:    mov v0.s[1], w12
; CHECK-DISABLE-NEXT:    lsr x11, x14, #19
; CHECK-DISABLE-NEXT:    ubfx x12, x10, #7, #25
; CHECK-DISABLE-NEXT:    ldrb w10, [x0, #18]
; CHECK-DISABLE-NEXT:    add x0, x0, #32
; CHECK-DISABLE-NEXT:    mov v1.s[2], w12
; CHECK-DISABLE-NEXT:    mov v0.s[2], w11
; CHECK-DISABLE-NEXT:    lsl x11, x16, #8
; CHECK-DISABLE-NEXT:    orr w10, w10, w11
; CHECK-DISABLE-NEXT:    mov v1.s[3], w9
; CHECK-DISABLE-NEXT:    add x9, x1, x8, lsl #3
; CHECK-DISABLE-NEXT:    add x8, x8, #1
; CHECK-DISABLE-NEXT:    mov v0.s[3], w10
; CHECK-DISABLE-NEXT:    cmp x8, #1000
; CHECK-DISABLE-NEXT:    xtn v1.4h, v1.4s
; CHECK-DISABLE-NEXT:    xtn v0.4h, v0.4s
; CHECK-DISABLE-NEXT:    rev16 v1.8b, v1.8b
...
; CHECK-NEXT:    ldr q5, [x0, #64]
; CHECK-NEXT:    add x0, x0, #128
; CHECK-NEXT:    uzp1.4s v1, v2, v1
; CHECK-NEXT:    uzp1.4s v2, v4, v3
; CHECK-NEXT:    uzp1.4s v0, v5, v0
...
; CHECK-BE-NEXT:    ldr d4, [x0, #80]
; CHECK-BE-NEXT:    ld1 { v5.2d }, [x9]
; CHECK-BE-NEXT:    xtn v1.2s, v1.2d
; CHECK-BE-NEXT:    add x9, x1, #10
; CHECK-BE-NEXT:    xtn v4.2s, v4.2d
; CHECK-BE-NEXT:    xtn v3.2s, v3.2d
; CHECK-BE-NEXT:    xtn v0.2s, v0.2d
; CHECK-BE-NEXT:    xtn v2.2s, v2.2d
; CHECK-BE-NEXT:    subs x8, x8, #1
; CHECK-BE-NEXT:    add x0, x0, #128
; CHECK-BE-NEXT:    xtn v5.2s, v5.2d
; CHECK-BE-NEXT:    rev32 v1.4h, v1.4h
; CHECK-BE-NEXT:    rev32 v4.4h, v4.4h
; CHECK-BE-NEXT:    rev32 v3.4h, v3.4h
; CHECK-BE-NEXT:    rev32 v0.4h, v0.4h
; CHECK-BE-NEXT:    rev32 v2.4h, v2.4h
; CHECK-BE-NEXT:    rev32 v5.4h, v5.4h
; CHECK-BE-NEXT:    uzp1 v1.4h, v1.4h, v3.4h
; CHECK-BE-NEXT:    uzp1 v0.4h, v0.4h, v4.4h
; CHECK-BE-NEXT:    uzp1 v2.4h, v5.4h, v2.4h
; CHECK-BE-NEXT:    rev16 v1.8b, v1.8b
; CHECK-BE-NEXT:    rev16 v3.8b, v0.8b
; CHECK-BE-NEXT:    rev16 v2.8b, v2.8b
; CHECK-BE-NEXT:    uzp1 v1.8b, v1.8b, v2.8b
; CHECK-BE-NEXT:    uzp1 v2.8b, v3.8b, v0.8b
; CHECK-BE-NEXT:    rev16 v0.16b, v0.16b
; CHECK-BE-NEXT:    mov v1.d[1], v2.d[0]
; CHECK-BE-NEXT:    st1 { v0.b }[4], [x9]
...
; CHECK-DISABLE-NEXT:    ld1 { v1.2d }, [x0]
; CHECK-DISABLE-NEXT:    ld1 { v0.2d }, [x9]
; CHECK-DISABLE-NEXT:    add x9, x0, #48
; CHECK-DISABLE-NEXT:    ld1 { v3.2d }, [x10]
; CHECK-DISABLE-NEXT:    ld1 { v2.2d }, [x9]
; CHECK-DISABLE-NEXT:    add x9, x0, #32
; CHECK-DISABLE-NEXT:    ldr d4, [x0, #80]
; CHECK-DISABLE-NEXT:    ld1 { v5.2d }, [x9]
; CHECK-DISABLE-NEXT:    xtn v1.2s, v1.2d
...
; CHECK-DISABLE-NEXT:    rev32 v2.4h, v2.4h
; CHECK-DISABLE-NEXT:    rev32 v5.4h, v5.4h
; CHECK-DISABLE-NEXT:    uzp1 v1.4h, v1.4h, v3.4h
; CHECK-DISABLE-NEXT:    uzp1 v0.4h, v0.4h, v4.4h
; CHECK-DISABLE-NEXT:    uzp1 v2.4h, v5.4h, v2.4h
; CHECK-DISABLE-NEXT:    rev16 v1.8b, v1.8b
; CHECK-DISABLE-NEXT:    rev16 v3.8b, v0.8b
; CHECK-DISABLE-NEXT:    rev16 v2.8b, v2.8b
; CHECK-DISABLE-NEXT:    uzp1 v1.8b, v1.8b, v2.8b
; CHECK-DISABLE-NEXT:    uzp1 v2.8b, v3.8b, v0.8b
; CHECK-DISABLE-NEXT:    rev16 v0.16b, v0.16b
; CHECK-DISABLE-NEXT:    mov v1.d[1], v2.d[0]
; CHECK-DISABLE-NEXT:    st1 { v0.b }[4], [x9]
